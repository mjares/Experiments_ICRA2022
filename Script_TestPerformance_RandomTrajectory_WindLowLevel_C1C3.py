...
operating_modes = [
    {'Nominal': [0, 0]},
    {'Rotor': [0.4, 0.3]}, {'Rotor': [0.3, 0.2]}, {'Rotor': [0.2, 0.1]}, {'Rotor': [0.1, 0.01]},
    {'AttNoise': [0.01, 0.4]}, {'AttNoise': [0.4, 0.8]}, {'AttNoise': [0.8, 1.2]}, {'AttNoise': [1.2, 1.4]},
    {'PosNoise': [0.01, 2]}, {'PosNoise': [2, 4]}, {'PosNoise': [4, 6]}, {'PosNoise': [6, 8]},
    {'Wind': [0.01, 5]}, {'Wind': [5, 10]}, {'Wind': [10, 15]}, {'Wind': [15, 20]}]
for controller in controller_list:
    print(f'Controller: {controller}')
    # Filename
    saveFilename = f'Secondary_Results/Nominal/Results_{controller}_Nominal_Full_EpCount_{no_episodes}.rs'
    # Performance
