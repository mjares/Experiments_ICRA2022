...
# Operating Modes
#####
op_mode_file_tag = 'small'
operating_modes = [
    {'Intermittent_Rotor': [[1, 500], [1, 10]]}, {'Intermittent_Rotor': [[500, 1000], [1, 10]]},
    {'Intermittent_Rotor': [[1000, 1500], [1, 10]]}  # ,  # 1 to 10 freq
    # {'Intermittent_Rotor': [[1, 500], [10, 50]]}, {'Intermittent_Rotor': [[500, 1000], [10, 50]]},
    # {'Intermittent_Rotor': [[1000, 1500], [10, 50]]},  # 10 to 50 freq
    # {'Intermittent_Rotor': [[1, 500], [50, 100]]}, {'Intermittent_Rotor': [[500, 1000], [50, 100]]},
    # {'Intermittent_Rotor': [[1000, 1500], [50, 100]]},  # 50 to 100 freq
    ]

for controller in controller_list:
    print(f'Controller: {controller}')
    # Filename
    saveFilename = f'Main_Results/Intermittent/Results_{controller}_Intermittent_LOE_EpCount_{no_episodes}_{op_mode_file_tag}.rs'
    # Performance
    ...
    for op_mode in operating_modes:
        ...
        for ii in range(no_episodes):
            ...
            if verbose:
                print(controller)
                print('Episode: ', f'{ii + 1}/{no_episodes}')
            total_steps = []
            trajectories = []
