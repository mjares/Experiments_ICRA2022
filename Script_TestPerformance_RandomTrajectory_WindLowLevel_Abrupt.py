...
operating_modes = [{'Wind': [0.01, 5]}, {'Wind': [5, 10]}, {'Wind': [10, 15]}, {'Wind': [15, 20]}]
for controller in controller_list:
    print(f'Controller: {controller}')
    # Filename
    saveFilename = f'Secondary_Results/Abrupt/Results_{controller}_Abrupt_Wnd_EpCount_{no_episodes}.rs'
    # Performance
