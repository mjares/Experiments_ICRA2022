...
operating_modes = [
    ...
    {'Temp_Rotor': [1, 125]}, {'Temp_Rotor': [125, 250]}, {'Temp_Rotor': [250, 375]}, {'Temp_Rotor': [375, 500]}
    ]

for controller in controller_list:
    print(f'Controller: {controller}')
    # Filename
    saveFilename = f'Main_Results/Abrupt/Results_{controller}_Abrupt_LOE_EpCount_{no_episodes}.rs'
    # Performance
